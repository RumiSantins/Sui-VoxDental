...
Este documento describe el flujo de operacion para mantener y actualizar el sistema SuiEgo en el servidor de produccion alojado en Google Cloud Platform.
...
- **Frontend**: `suiego.35.202.203.240.nip.io`
- **Backend**: `api.suiego.35.202.203.240.nip.io`
...
- **Configuracion de Nginx**: `/etc/nginx/sites-available/suiego`

---

## Mantenimiento de la Base de Datos

La base de datos SQLite se almacena en el archivo `suiego.db` en la raiz del proyecto del servidor. 
...
```bash
docker ps
docker logs suiego_backend --tail 50
```
