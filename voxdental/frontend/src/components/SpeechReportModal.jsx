            ...
            <div className="bg-white dark:bg-zinc-900 w-full max-w-md rounded-3xl shadow-xl border border-red-200 dark:border-red-900/30 flex flex-col transform animate-in zoom-in duration-300">
                <div className="p-6 border-b border-slate-100 dark:border-red-900/20 bg-red-50 dark:bg-red-950/10 flex justify-between items-center">
                    <div className="flex items-center gap-3 text-red-600 dark:text-red-400">
                        ...
                        <h3 className="font-bold text-xl tracking-tight uppercase">Reportar Error de Voz</h3>
                    </div>
                ...
                <div className="p-8 space-y-6">
                    {isSuccess ? (
                        <div className="py-10 text-center space-y-4 animate-in fade-in zoom-in">
                            ...
                            <h4 className="text-2xl font-bold text-slate-800 dark:text-white">¡Gracias!</h4>
                            <p className="text-gray-500 dark:text-slate-400">Tu reporte nos ayuda a mejorar la IA.</p>
                        </div>
                    ) : (
                        <>
                            <div>
                                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 block">Lo que la IA escuchó:</label>
                            ...
                            <div>
                                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 block">Lo que realmente quisiste decir:</label>
                                <textarea 
                                    ...
                                    placeholder="Ej: Quise decir Caries Oclusal en la 16..."
                                    value={expected}
